...
# Create route tables
az network route-table create "vnet1-subnet1"
az network route-table create "vnet2-subnet1"
az network route-table create "vnet3-subnet1"
az network route-table create "vnet4-gw"
